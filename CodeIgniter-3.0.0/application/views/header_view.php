...
<html class="csstransforms no-csstransforms3d csstransitions">
	<head>
		...
		<script type="text/javascript" src="/NothingToSeeHere/CodeIgniter-3.0.0/vanilla/js/embed.js"></script>

		<script type="text/javascript" src="<?php echo base_url('NothingToSeeHere/CodeIgniter-3.0.0/vanilla/js/embed.js')?>"></script>
