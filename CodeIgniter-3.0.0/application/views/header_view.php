...
<html class="csstransforms no-csstransforms3d csstransitions">
	<head>
		...
		<meta name="keywords" content="TEDxUHasselt TEDx Universiteit Hasselt UHasselt ">
		...
		<link href="<?php echo base_url('assets/css/Navigation/assets/js/jquery.js')?>" rel="stylesheet">
