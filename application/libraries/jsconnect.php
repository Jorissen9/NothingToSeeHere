<?php
/**
 * This file is an update to Todd's jsConnect single sign on PHP functions to support CodeIgniter.
 * @author Michael Anderson <michael@unchartedtechnologies.com>
 * @version 1.0
...
/**
 * This main part of this file contains the client code for Vanilla jsConnect single sign on.
